...
export const initCalendarSettings = () => {
  ...
  form.addEventListener('submit', (e) => {
    ...
    // Get rejection reasons from hidden data field
    const rejectionReasonsInput = document.getElementById('rejectionReasonsData') as HTMLInputElement;
    const rejectionReasons: string[] = rejectionReasonsInput
      ? JSON.parse(rejectionReasonsInput.value || '[]')
      : currentSettings.rejectionReasons;
